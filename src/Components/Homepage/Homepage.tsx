import { Container, Box, Form } from 'react-bulma-components';
  ...
  return (
    <Container className={styles.container}>
      <form className={styles.form}>
        <Form.Field>
          <Box>
            <Form.Label htmlFor="mood-select">What is your mood? 🎉</Form.Label>

            <Form.Control>
              <Form.Select id="mood-select">
                <option value="">Don&apos;t know yet / Anything will do</option>
        ...
        <Form.Field>
          <Box>
            <Form.Label htmlFor="country-select">What country? 🌎</Form.Label>
        ...
        <Form.Field>
          <Box>
            <Form.Label htmlFor="price-select">
              What is your budget? 💸
            </Form.Label>
            ...
            >
              <p>From</p>
              <Form.Input id="price-select"></Form.Input>
              <p>To</p>
